...
def to_ascii():
    # Get and validate a single character from the user
    # While - check length
    length = 2
    while length != 1:
...
def greeting():
    ...
    print(" 1. Convert from character to ASCII")
    print(" 2. Convert from a ASCII to a character")
    print(" 3. Quit")
...
def main():
    ...
    while True:
        if choice == 1:
            ...
            print("\nI'm sorry but that option isn't valid")
            choice = greeting()
